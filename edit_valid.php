...
<body>
	...
	<table id="form_isi">
		...
		<tr>
			<td>Username</td>
			<td><input id="username" title="Nama yang akan di gunakan saat login server kami. Min. 6 karakter (contoh: Barrur)" name="username" type="text" maxlength="100"></td>
			<td></td>
		</tr>
		<tr>
			<td>Password</td>
		...
		<tr>
			<td>Nama Lengkap</td>
			<td><input id="namane" title="Masukan nama lengkapmu. (Contoh : Barrur Rhozi)" name="namane" type="text" maxlength="100"></td>
			<td></td>
		</tr>
	<tr>
		<td>Jenis Kelamin</td>
		...
		<tr>
			<td>Tempat Lahir</td>
			<td><input id="tlahir" title="Masukan tempat lahir anda?(contoh: pandeglang)" name="tlahir" type="text" maxlength="100"></td>
			<td></td>
		</tr>
		<tr>
			<td>Tanggal Lahir</td>
			<td><input id="tgllahir" title="Masukan tanggal lahir anda?" name="tgllahir" type="text" value="00/00/000" maxlength="100"></td>
			<td></td>
		</tr>
		<tr>
			<td>Alamat</td>
			<td><input id="alamat" title="Masukan alamat anda ? (contoh: Pandeglang)" name="alamat" type="text" maxlength="100"></td>
			<td></td>
		</tr>		
		<tr>
	...
	<tr>
		<td>Facebook</td>
		<td><input title="Masukan Facebook kamu disini." name="fb" id="fb" type="text"></td>
		<td></td>
	</tr>
	<tr>
		<td>Twitter</td>
		<td><input title="masukan Twitter kamu,.. biar bisa mentionan" name="twitter" id="twitter" type="text"></td>
		<td></td>
	</tr>
	<tr>
		<td>Hobi</td>
		...
		<tr>
			<td>Alasan Masuk</td>
			<td><textarea title="Kenapa alasan kamu masuk SCC ?" name="alasan" id="tarea"></textarea></td>
			<td></td>
		</tr>
	</table>
	<div align="center">
